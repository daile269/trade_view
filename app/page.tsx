      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-10 tracking-wide">
            <a href="#solution" className="text-white hover:text-red-500 transition">Giải Pháp</a>
            <a href="#content" className="text-white hover:text-red-500 transition">Nội Dung</a>
            <a href="#instructor" className="text-white hover:text-red-500 transition">Giảng Viên</a>
            <a href="#feedback" className="text-white hover:text-red-500 transition">Đánh Giá</a>
            <a href="#contact" className="text-white hover:text-red-500 transition">Liên Hệ</a>
          </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-black border-t border-red-600 animate-slide-down">
          <div className="px-4 pt-3 pb-4 space-y-2">
            <a href="#solution" className="block px-3 py-2 text-white rounded hover:bg-red-900 transition">Giải Pháp</a>
            <a href="#content" className="block px-3 py-2 text-white rounded hover:bg-red-900 transition">Nội Dung</a>
            <a href="#instructor" className="block px-3 py-2 text-white rounded hover:bg-red-900 transition">Giảng Viên</a>
            <a href="#feedback" className="block px-3 py-2 text-white rounded hover:bg-red-900 transition">Đánh Giá</a>
            <a href="#contact" className="block px-3 py-2 text-white rounded hover:bg-red-900 transition">Liên Hệ</a>
            <a
              href="#register"
  ...
  <div className="max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-16 items-center" >
    ...
    <div className="space-y-8 text-white">
      ...
      <p className="text-gray-200 leading-relaxed text-sm max-w-xl">
        Khóa học miễn phí 3 buổi online, giúp bạn đọc vị dòng tiền cá mập và
        giao dịch Vàng XAUUSD an toàn – lợi nhuận ổn định.Chỉ cần 1 công cụ & 1 tư duy đúng – không còn sợ cháy tài khoản.
      </p>
      ...
      >
        ...
        <p className="text-sm font-bold uppercase text-white mb-2">
          ...
          Chỉ dành cho<span className="text-red-800 font-bold underline "> 100 slot</span> – đăng ký nhanh nhất!
        </p>
    ...
    <div className="relative flex justify-center items-center">
      ...
      <div className="absolute -bottom-8 bg-red-700 px-6 py-3 rounded-md text-center shadow-lg w-[90%] max-w-sm">
        ...
        <p className="text-sm text-gray-200">
          Nhà giao dịch chuyên nghiệp với hơn 6 năm kinh nghiệm Forex &amp; XAUUSD
        </p>
      </div>
    </div>
  </div>
    ...
    <div className="space-y-6">
      ...
      <ul className="space-y-3 text-lg text-gray-200">
        <li className="flex items-start">
          ...
          <span><span className="text-red-500 font-semibold">90%</span> trader thua lỗ trong thị trường Forex</span>
        </li>
        <li className="flex items-start">
          <span className="text-red-600 mr-2">▶</span>
          <span>Học rất nhiều khoá học giao dịch nhưng vẫn <span className="text-red-500 font-semibold">thua lỗ</span></span>
        </li>
        <li className="flex items-start">
          <span className="text-red-600 mr-2">▶</span>
          <span>Giao dịch theo <span className="italic">"cảm tính"</span> hoặc tín hiệu từ người khác <span className="text-red-500 font-semibold">→ Cháy tài khoản</span></span>
        </li>
        <li className="flex items-start">
          <span className="text-red-600 mr-2">▶</span>
          <span>Trader <span className="text-red-500 font-semibold">không kiểm soát được tâm lý</span> và vốn</span>
        </li>
        <li className="flex items-start">
          <span className="text-red-600 mr-2">▶</span>
          <span>Không hiểu được <span className="text-red-500 font-semibold">tâm lý thị trường</span> đằng sau mô hình giá</span>
        </li>
      </ul>
    </div>
  </div>
        ...
        {[
          ...
          >
            <div className="bg-[url('/money-bg.jpg')] bg-cover bg-center w-24 h-24 flex items-center justify-center border-r border-red-700">
              <span className="text-3xl font-bold text-yellow-400">{idx + 1}</span>
            </div>
            <div className="p-5">
              <h4 className="text-xl font-bold text-red-500 uppercase">{session.title}</h4>
...
<section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-[#190000] bg-cover bg-center" style={{ backgroundImage: "url('/background2.jpg')" }}>
  <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
    ...
    <div className="space-y-5">
      {[
        ...
        <div key={i} className=" flex items-start space-x-4 bg-gradient-to-r from-[#2a0000] border border-red-700 rounded-md p-4 hover:translate-x-1 transition">
          <div className="flex-shrink-0 w-7 h-7 bg-white rounded-full flex items-center justify-center shadow-md">
            <svg className="w-4 h-4 text-red-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
            </svg>
          </div>
          <p className="text-white text-base md:text-lg leading-snug">{text}</p>
        </div>
      ))}
    </div>
    ...
    <div className="text-center">
      <h2 className="text-xl md:text-2xl font-bold text-red-500 uppercase mb-2">BẠN SẼ NHẬN ĐƯỢC GÌ</h2>
      ...
      <div className="inline-block border-4 border-red-700 rounded-lg overflow-hidden shadow-[0_0_30px_rgba(255,0,0,0.4)]">
        <img src="/lic.jpg" alt="Trước Sau Học" className="w-full max-w-md object-cover" />
      </div>
    </div>
  </div>
</section>
...
<section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-[#100000] border-t border-red-700" id="instructor">
  <div className="max-w-6xl mx-auto bg-gradient-to-br from-black to-[#1a0000] rounded-xl overflow-hidden border border-red-800 shadow-[0_0_30px_rgba(255,0,0,0.3)]">
    <div className="grid md:grid-cols-2 gap-8 items-center">
      ...
      <div className="relative bg-[#1a0000] h-full">
        ...
        <img src="/mter.jpg" alt="Master Phúc" className="w-full h-full object-cover rounded-tl-xl md:rounded-tl-xl md:rounded-bl-xl" />
      </div>
      ...
      <div className="p-8 space-y-5">
        ...
        <p className="text-gray-300">
          Nhà giao dịch chuyên nghiệp với hơn <b>6 năm kinh nghiệm Forex & chuyên sâu XAUUSD</b>
        </p>
        ...
        <div className="bg-red-700/90 rounded-lg p-4 text-white text-sm mt-6">
          Master Phúc sẽ hướng dẫn bạn từng bước để làm chủ phương pháp Nến Thanh Khoản để giao dịch
        </div>

        {/* Social icons */}
        <div className="flex space-x-4 mt-4">
          <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-green-500 hover:bg-green-600 transition">
            <i className="fab fa-whatsapp text-white"></i>
          </a>
          <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-blue-500 hover:bg-blue-600 transition">
            <i className="fab fa-facebook-f text-white"></i>
          </a>
          <a href="#" className="w-8 h-8 flex items-center justify-center rounded-full bg-sky-500 hover:bg-sky-600 transition">
  ...
  <div className="max-w-6xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 text-white text-sm md:text-base">
      <div className="flex text-red-600 items-start space-x-3 mt-8 ">
        ...
        <p>Phát triển phương pháp Nến Thanh Khoản dựa trên Wyckoff, VSA kết hợp Price Action</p>
      </div>
      <div className="flex text-red-600 items-start space-x-3 mt-8">
        <span className="text-red-600 text-5xl mt-0.5">⚙️</span>
      ...
      <div className="flex text-red-600 items-start space-x-3 mt-8">
        <span className="text-red-600 text-5xl mt-0.5">⚙️</span>
        <p>Nhiều học viên đạt lợi nhuận 15–40%/tháng ổn định và bền vững</p>
      </div>
      <div className="flex text-red-600 items-start space-x-3 mt-8">
        <span className="text-red-600 text-5xl mt-0.5">⚙️</span>
        <p>Hệ thống đào tạo từ cơ bản đến nâng cao – thực chiến trực tiếp</p>
      </div>
      <div className="flex text-red-600 items-start space-x-3 mt-8">
        <span className="text-red-600 text-5xl mt-0.5">⚙️</span>
...
<section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-[#190000] bg-cover bg-center" style={{ backgroundImage: "url('/background3.jpg')" }}>
  <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
    ...
    <div className="text-white">
      <h3 className="text-red-600 font-bold uppercase text-lg mb-2">Khóa học này</h3>
      <h2 className="text-3xl md:text-4xl font-bold mb-6 uppercase">Dành cho những ai?</h2>
...
<section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-[#0f0000] border-t border-red-700">
  <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
    ...
    {/* LEFT - Text Content */}
    <div>
      <h3 className="text-red-600 font-bold uppercase text-lg">Quyền lợi bạn sẽ nhận được</h3>
      <h2 className="text-3xl md:text-4xl font-bold text-white uppercase mb-6">Khi tham gia khóa học</h2>
      ...
      <div className="space-y-4">
        {[
          ...
          <div key={i} className="flex items-center space-x-3 bg-red-900/70 border border-red-700 px-5 py-3 rounded-md">
...
>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-black/80 border-2 border-red-700 p-6 text-center rounded-lg">
        <p className="text-xl md:text-2xl font-bold text-white mb-1">
          Tổng trị giá hơn : <span className="line-through text-gray-400">15.000.000 VNĐ</span>
        </p>
        <p className="text-lg md:text-xl text-yellow-400 font-semibold">
          Nhưng <span className="text-red-500 font-bold">MIỄN PHÍ 100%</span> nếu bạn đăng ký hôm nay
        </p>
      </div>
      ...
      <div className="bg-red-700/90 border border-red-600 p-8 rounded-lg shadow-[0_0_30px_rgba(255,0,0,0.3)]">
        ...
        <p className="text-yellow-300 text-center font-semibold mb-4 text-sm md:text-base">
          Tham gia khóa học miễn phí ngay! <br /> Chỉ dành cho <span className="text-white">100 slot</span> đăng ký nhanh nhất
        </p>
        ...
        <p className="text-center text-xs text-gray-100 mt-3">
          Sau khi đủ chỗ, form đăng ký sẽ tự động đóng lại và ưu đãi sẽ bị hủy.
        </p>
      </div>
    </div>
  </div>
  ...
  <div className="text-center text-2xl mt-12">
    ...
    <p className="text-red-500 font-bold uppercase">
      Hãy cho bản thân 3 buổi để thay đổi cách bạn nhìn thị trường – mãi mãi.
    </p>
  </div>
</section>
    ...
    <div className="grid md:grid-cols-2 gap-8 text-sm md:text-base">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-start space-x-2">
          <span className="text-red-600 text-lg mt-0.5">▶</span>
          <p className="text-white">
            <span className="font-semibold">Thời lượng:</span> 90 phút/buổi – 2 buổi
          </p>
        </div>
        <div className="flex items-start space-x-2">
          <span className="text-red-600 text-lg mt-0.5">▶</span>
      ...
      <div className="space-y-3">
        <div className="flex items-start space-x-2">
          <span className="text-red-600 text-lg mt-0.5">▶</span>
          <p className="text-white">
            <span className="font-semibold">Giảng viên:</span> Master Phúc – HP Trading
          </p>
        </div>
        <div className="flex items-start space-x-2">
          <span className="text-red-600 text-lg mt-0.5">▶</span>
          <p className="text-white">
            <span className="font-semibold">Phí tham gia:</span> Hoàn toàn miễn phí
          </p>
        </div>
      </div>
    </div>
